# -*- coding: utf-8 -*-
"""
Created on Thu Sep 19 21:32:08 2019
...
def generate_data(array_1):
    ...
    X = values.reshape(len(values), 2, 80)
    #print("X")
    #print(X)
    #print("X shape")
    #print(X.shape)
...
model.add(LSTM(80, input_shape=(2, 80), return_sequences=True))
